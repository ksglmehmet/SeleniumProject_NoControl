...
#     print(f"\n{i}. sayfada yer alan tifflerin bilgileri kontrol ediliyor.\n")
#     page_count = []
...
try:
    Ilgili_Tiff = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, f'#rowCell0 > td.browseItemName > a:nth-child(2)')))  
    Ilgili_Tiff.click()
